defmodule SymphonyElixirWeb.StaticAssets do
  ...
  @tool_renderers_css_path Path.expand("../../priv/static/tool-renderers.css", __DIR__)
  ...
  @external_resource @tool_renderers_css_path
  ...
  @tool_renderers_css File.read!(@tool_renderers_css_path)
  ...
  @assets %{
    ...
    "/tool-renderers.css" => {"text/css", @tool_renderers_css},
